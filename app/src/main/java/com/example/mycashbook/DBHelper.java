...
public class DBHelper extends SQLiteOpenHelper {
     ...
     * @param user
     */
    public void addUser(com.example.mycashbook.User user) {
     ...
     * @return list
     */
    public List<com.example.mycashbook.User> getAllUser() {
        ...
        String sortOrder =
                COLUMN_USERNAME + " ASC";
        List<com.example.mycashbook.User> userList = new ArrayList<com.example.mycashbook.User>();
        ...
        if (cursor.moveToFirst()) {
            do {
                com.example.mycashbook.User user = new com.example.mycashbook.User();
     ...
     * @param user
     */
    public void updateUser(com.example.mycashbook.User user) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COLUMN_USER_PASSWORD, user.getPassword());
        // updating row
     ...
     * @param user
     */
    public void deleteUser(com.example.mycashbook.User user) {
        SQLiteDatabase db = this.getWritableDatabase();
