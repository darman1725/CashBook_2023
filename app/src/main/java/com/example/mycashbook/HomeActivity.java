...
public class HomeActivity extends AppCompatActivity {
    ...
    private ArrayList<com.example.mycashbook.Cashflow> listCashflow;
    ...
    public void toIncome(View v){
        Intent intent = new Intent(getApplicationContext(), com.example.mycashbook.PemasukanActivity.class);
    ...
    public void toCashflow(View v){
        Intent intent = new Intent(getApplicationContext(), com.example.mycashbook.CashFlowActivity.class);
        intent.putExtra("username", username);
        startActivity(intent);
        finish();
    }
    public void toSetting(View v){
        Intent intent = new Intent(getApplicationContext(), com.example.mycashbook.SettingsActivity.class);
        intent.putExtra("username", username);
        startActivity(intent);
        finish();
    }
